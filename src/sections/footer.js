...
export default function Footer({ ...restProps }) {
  return (
    <>
      <footer
        className="py-4 md:py-10 bg-dark-400 text-dark-300"
        {...restProps}
      >
        <div className="container">
          ...
          <h3 className="font-semi-bold text-base mb-4">Payment methods</h3>
          ...
          <h3 className="font-semi-bold text-base mb-4">Social networks</h3>
          ...
          <h3 className="font-semi-bold text-base mb-4">Other</h3>
